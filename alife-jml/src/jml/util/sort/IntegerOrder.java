...
/**
 * <p>Title: IntegerOrder </p>
 * <p>Description: Compares two Integer</p>
...
public class IntegerOrder extends Order {
  
  /**
   * Determines if the object is less than (in some order) the given object
   * @param one Comparison object1 (int)
   * @param two Comparison object2 (int)
