...
/**
 * <p>Title: LabelExtractor</p>
 * <p>Description: Gets the label of a labeledobject</p>
...
public class LabelExtractor extends DataTransformation {
  /**
   ...
   * @return Transformed Data Sample (new Integer)
   */
  public Object apply(Object data) {
    LabeledObject x = (LabeledObject) data;
    return new Integer(x.getLabel());
  }
}
