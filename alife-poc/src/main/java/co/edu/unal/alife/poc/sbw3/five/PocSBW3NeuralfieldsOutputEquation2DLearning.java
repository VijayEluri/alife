...
public class PocSBW3NeuralfieldsOutputEquation2DLearning implements
		IPocNeuralfieldOutputEquation {

	protected static final Logger logger = LoggerFactory
			.getLogger(PocSBW3NeuralfieldsOutputEquation2DLearning.class);

	APocNeuralfieldSpec spec;

	public PocSBW3NeuralfieldsOutputEquation2DLearning(APocNeuralfieldSpec spec) {
		super();
		this.spec = spec;
	}
