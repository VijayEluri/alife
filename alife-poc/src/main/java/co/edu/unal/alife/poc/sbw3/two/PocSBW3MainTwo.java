...
public class PocSBW3MainTwo implements Runnable {

	static final Logger logger = LoggerFactory.getLogger(PocSBW3MainTwo.class);
	double[] qi;
	double gamma;
	double tf;
	PocSBW3ControllerTwo controller;

	public PocSBW3MainTwo(double[] qi, double gamma, PocSBW3ControllerTwo controller,
			double tf) {
		super();
		this.qi = qi;
		this.gamma = gamma;
	...
	public static void main(String[] args) {
		...
		double time = 20;
		PocSBW3MainTwo main = new PocSBW3MainTwo(qi, gamma, controller, time);
