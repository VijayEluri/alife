 ...
 */
public class SBWKControllerParameters {
	private int size;
	 ...
	 * @param size
	 */
	public SBWKControllerParameters(List<Double> inputKernel, List<Double> selfKernel, int size) {
		this.size = size;
	 ...
	 * @param size
	 */
	public SBWKControllerParameters(int size, double minValue, double maxValue) {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		return new SBWKControllerParameters(listInput, listSelf, size);
	}
