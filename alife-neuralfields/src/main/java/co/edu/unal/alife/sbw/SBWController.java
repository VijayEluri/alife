...
public class SBWController {
	 ...
	 * @param parameters
	 */
	public SBWController(int halfSize, SBWKControllerParameters parameters) {
		super();
	 ...
	 * @return
	 */
	private AbstractDeltaField buildController(SBWKControllerParameters parameters, int halfSize) {
		int N = 3;
...
//		pendulumPopulation.setElementValue(PendulumEquation.STATE_X, initialPos);
		...
		SBWEquation pendulumEquation = new SBWEquation(processingPopulation);
